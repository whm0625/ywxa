function [sys,x0,str,ts,simStateCompliance] = linear_flying2(t,x,u,flag,A_all, B_all)
switch flag,
  case 0,
    [sys,x0,str,ts,simStateCompliance]=mdlInitializeSizes;
  case 1,
    sys=mdlDerivatives(t,x,u,A_all, B_all);
  case 2,
    sys=mdlUpdate(t,x,u);
  case 3,
...
function sys=mdlDerivatives(t,x,u,A_all, B_all)
...
%     end
    ...
    % 获取当前模型的参数
    A_model = A_all(:,:,model_idx);
    B_model = B_all(:,:,model_idx);
