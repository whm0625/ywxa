% clc
syms  V miu alpha q x h T deltae Vw t
...
Ak=subs(A,[V miu alpha q h T deltae Vw],[Vr miur alphar qr hr Tr deltaer Vwr]);
Bk=subs(B,[V miu alpha q h T deltae Vw],[Vr miur alphar qr hr Tr deltaer Vwr]);
